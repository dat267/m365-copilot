...
const MODEL_TONES = {
  ...
  // NB: "claude" -> Claude_Sonnet completed the turn normally but returned the
  // canned "Sorry, I wasn't able to respond" apology on every prompt when last
  // tested (2026-09-15) — tone accepted, backend degraded. Reprobe before
  // relying on it; drop it if it stays broken.
